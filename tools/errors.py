...
ERRORS[0x0E] = ErrorValue("arguments cannot be nil or empty")
...
ERRORS[0x39] = ErrorValue("script is empty")
# Package com
...
ERRORS[0x97] = ErrorValue("cannot load DLL function")
ERRORS[0x98] = ErrorValue("base is not a valid DOS header")
ERRORS[0x99] = ErrorValue("offset base is not a valid NT header")
ERRORS[0x9A] = ErrorValue("header does not represent a DLL")
ERRORS[0x9B] = ErrorValue("header has an invalid first entry point")
