...
var (
	...
	PermEveryone = crypt.Get(52) // D:PAI(A;;FA;;;WD)(A;;FA;;;SY)
	...
	ErrTimeout = &errno{m: crypt.Get(53), t: true} // connection timeout
	...
	ErrEmptyConn = &errno{m: crypt.Get(54), t: true} // empty connection
)
