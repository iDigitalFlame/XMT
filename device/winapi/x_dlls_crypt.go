...
var (
	...
	funcLogonUser                                           = dllAdvapi32.proc(crypt.Get(29))  // LogonUserW
	...
	funcGetWindowInfo                                       = dllUser32.proc(crypt.Get(31))    // GetWindowInfo
	funcDbgBreakPoint                                       = dllNtdll.proc(crypt.Get(25))     // DbgBreakPoint
	...
	funcGetWindowLongPtr                                    = dllUser32.proc(crypt.Get(32))    // GetWindowLongPtrW
	funcSetWindowLongPtr                                    = dllUser32.proc(crypt.Get(33))    // SetWindowLongPtrW
	...
	funcCreateWellKnownSid                                  = dllAdvapi32.proc(crypt.Get(22))  // CreateWellKnownSid
	...
	funcSetTokenInformation                                 = dllAdvapi32.proc(crypt.Get(117)) // SetTokenInformation
	...
	funcSystemParametersInfo                                = dllUser32.proc(crypt.Get(30))    // SystemParametersInfoW
	...
	funcCreateProcessWithLogon                              = dllAdvapi32.proc(crypt.Get(27))  // CreateProcessWithLogonW
	funcImpersonateLoggedOnUser                             = dllAdvapi32.proc(crypt.Get(26))  // ImpersonateLoggedOnUser
