...
var (
	...
	funcEtwEventRegister            = dllNtdll.proc(0xC0B4D94C)
	funcNtSuspendProcess            = dllNtdll.sysProc(0x8BD95BF8)
	funcNtCreateThreadEx            = dllNtdll.sysProc(0x8E6261C)
	funcNtCancelIoFileEx            = dllNtdll.sysProc(0xD4909C18)
	...
	funcRtlCopyMappedMemory         = dllNtdll.proc(0x381752E6)
	...
	funcEtwNotificationRegister     = dllNtdll.proc(0x7B7F821F)
	...
	funcRtlWow64GetProcessMachines  = dllNtdll.proc(0x982D219D)
